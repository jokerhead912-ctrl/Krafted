...
// S13. structural pins
{
  ok(src.indexOf('// v7.20.0:') > 0, 'v7.20.0 provenance comments are present');
  ...
  eq(c.split('const _docCard = wheelDocCardTarget(e);').length - 1, 1, 'the v7.20.0 wheel gate is still there');
