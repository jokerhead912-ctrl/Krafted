...
// ═══════════════════════════════════════════════════════════════════════
{
  ok(src.indexOf("var KRAFTED_VERSION = '7.0.51';") >= 0, 'KRAFTED_VERSION bumped');
  ok(src.indexOf('<title>Krafted v7.0.51</title>') >= 0, 'title bumped');
  ok(sw.indexOf("const CACHE_NAME = 'krafted-v7.0.51-'") >= 0, 'sw CACHE_NAME bumped');
  ok(sw.indexOf("const APP_VERSION = '7.0.51';") >= 0, 'sw APP_VERSION bumped');
}
