...
(async () => {
  ...
  hasIn(overlay.innerHTML, 'saved back onto each image', 'the dialog says typing is written back (v7.23.0)');
  hasIn(overlay.innerHTML, 'notes-export-rows', 'there is a per-image rows host (v7.23.0)');
