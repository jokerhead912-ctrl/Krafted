...
section(function () {
  ...
  api._maybeTidy(12);
  api._maybeTidy(13);
  eq(tidyCalls, 1, 'v7.10.0: the tidy fires exactly once when the last item lands');
  ...
  api._maybeTidy(99);
  eq(tidyCalls, 3, 'v7.10.0: a single-item import does NOT auto-tidy');
...
section(function () {
  ...
  eq(b.rec.disposed.length, 1, 'v7.10.0: deleting the last member dissolves the group');
