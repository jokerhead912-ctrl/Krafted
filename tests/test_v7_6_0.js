...
section(function () {
  ...
  eq(calls.rename.length, 1, 'v7.15.0: creating a group opens the rename exactly once');
...
section(function () {
  ...
  eq(midEdit.labelEl.style.display, 'block', 'v7.15.0: a nameless chip MID-RENAME stays shown');
  eq(midEdit.labelEl.style.left, '92px', 'v7.15.0: a nameless chip MID-RENAME is placed, not parked at 0');
