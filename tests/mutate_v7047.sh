...
run() {   # run(label)
  local out
  out=$(KRAFTED_HTML=$TMP/mut.html KRAFTED_SW=$TMP/sw.js $NODE Krafted/tests/test_v7047.js 2>&1)
...
FRAGILE=0
EQUIV=0
print "mutation check: v7.25.0 suite (the tape waits for you)"
...
mutate "the title does not move" \
  "<title>Krafted v7.25.0</title>" \
  "<title>Krafted v7.24.0</title>"
