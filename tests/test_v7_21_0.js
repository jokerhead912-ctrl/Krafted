...
eq(selOf(['a', 'img']), 'a',
  'a video + an image selected still resolves to the video (v7.25.0; used to fall through to null)');
...
eq(w4.videoAnnoCommentTime({ frame: 100 }, CLIP_A), 4,
  'a pre-v7.25.0 .kpak carrying only frame back-fills time = frame / THIS clip fps');
