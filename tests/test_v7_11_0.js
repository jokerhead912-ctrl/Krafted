...
section(function () {
  ...
  near(env.item.natW, 300, 'plain crop: output width is the v7.20.0 number (unchanged)', 1);
  near(env.item.natH, 150, 'plain crop: output height is the v7.20.0 number (unchanged)', 1);
